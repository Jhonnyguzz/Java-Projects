...
public class SingleServer 
{
  ...
  {	
	...
	System.out.println("The time average size of the queue was: " + 
			 String.valueOf(aveQueueSize.getContinAve(clock.getTime()))+"\n"+"The time average utilization of the server was: " + 
			 String.valueOf(utilization.getContinAve(clock.getTime()))+"\n"+"The aveage wait in queue was: " + 
			 String.valueOf(waitTime.getDiscreteAverage())+"\n"+"Wait times were divided by: " + 
